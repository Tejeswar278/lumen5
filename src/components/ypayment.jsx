...
//           />
//           <br />
//           <p>Subscribe to Premium - v1.5 (Annual) </p>
//           <div className="left1">
//             {/* <h3>$ </h3> {ypayment.price} */}
//             <h3>$ 708.00 </h3>
//             <p className="per">
//               <p>per</p>
//               <p>year</p>
...
//               <p>Premium - v1.5 (Annual) </p>
//               <p className="Billed">Billed yearly </p>
//             </div>
//             {/* <p className="left2b"> $ {ypayment.price}</p> */}
//             <p className="left2b"> $ 708</p>
//           </div>

//           <div className="left3">
//             <p>Subtotal</p>
//             {/* <p className="left3b"> $ {ypayment.price}</p> */}
//             <p className="left3b"> $ 708</p>
//           </div>
...
//           <div className="left5">
//             <p>Total due today</p>
//             {/* <p className="right"> $ {ypayment.price}</p> */}
//             <p className="right"> $ 708</p>
//           </div>
//         </div>
...
//             <p>Email</p>
//             <p>Shiva{ypayment.price}</p>
//           </div>
//           <br />
//           Card information
//           <div>
//             <div className="right2">
//               <input type="number" placeholder="1234 1231 1234 1234" />
...
//           <p className="EnterAdd">Enter address manualy</p>
//           <div className="right3">
//             <input type="checkbox" name="" id="" />
//             <div>
//               <p>Sava my info for security 1-click checkout</p>
//               <p>Pay faster on Lumen5 Technologys Lts and thousands of sites.</p>
//             </div>
//           </div>
//           <br />
...
//             <p>
//               By confirming your subscriptio, you allow Lumen5 Technologies Ltd to charge your card for this payment and future payments in accordance with
//               their terms.
//             </p>
//           </div>
//         </div>
      ...
      <div id="container">
        <div id="leftDiv">
          ...
          <div class="premiumPayPage">
            ...
            <h3 id="price1">
              $ <span> </span>U{ypayment.price}
            </h3>
          </div>
          <div id="toatlAmt">
            <h3>Subtotal</h3>
            <h3 id="price2">
              $ <span> </span>S{ypayment.price}
            </h3>
          </div>
          <hr />
          <div id="tax">
